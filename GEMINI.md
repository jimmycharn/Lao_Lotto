...
### 3. ห้ามลบ/แก้ไข/ทดสอบทำลายข้อมูลในฐานข้อมูลโดยเด็ดขาดหากไม่ได้รับอนุญาตชัดเจนจากผู้ใช้ (Strict Confirmation Required Before Any DB Deletion / Mutation)
- **กฎเหล็กด้านความปลอดภัยของข้อมูล (Critical Data Safety Rule)**:
  - **ห้ามตัดสินใจลบข้อมูลใดๆ โดยพลการเด็ดขาด**: ไม่ว่าจะเป็นการทดสอบ, การแก้ปัญหาเฉพาะหน้า, หรือในสภาพแวดล้อมใดก็ตาม ห้ามรันคำสั่ง `DELETE`, `TRUNCATE`, `DROP` หรือคำสั่งทดสอบที่มีผลกระทบต่อข้อมูลในฐานข้อมูลโดยไม่ได้รับอนุญาต
  - **ต้องถามและขออนุญาตผู้ใช้ก่อนทุกครั้ง**: ก่อนจะแตะต้องหรือลบข้อมูลใดๆ ต้องอธิบายให้ผู้ใช้ทราบอย่างชัดเจนเสมอว่า ข้อมูลนั้นคืออะไร มีความสำคัญอย่างไร ผลกระทบคืออะไร และรอคำยินยอม/อนุญาตที่ชัดเจนจากผู้ใช้ก่อนเท่านั้นจึงจะดำเนินการได้
  - **ห้ามสร้าง/เมคข้อมูลปลอม (Mock / Fabricated Data) ลงในระบบจริงโดยเด็ดขาด**: หากข้อมูลใดสูญหาย ถูกลบไปแล้ว หรือไม่สามารถกู้คืนได้ ต้องแจ้งความจริงกับผู้ใช้ตรงไปตรงมาทันทีว่า "กู้คืนไม่ได้" ห้ามแต่งเติม สุ่มสร้าง หรือเมคข้อมูลตัวเลขขึ้นมาเองเพื่อแก้ปัญหาเฉพาะหน้าเด็ดขาด
