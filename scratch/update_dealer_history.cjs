...
// 1. Replace summary box (lines 2648 to 2681, 0-indexed: 2647 to 2680)
const summaryBoxLines = [
...
lines.splice(2647, 2681 - 2647 + 1, ...summaryBoxLines);

// 2. Replace expanded card details (around line 2780 to 2875)
let detailsStart = -1;
let detailsEnd = -1;
...
console.log('Details indexes found:', { detailsStart, detailsEnd });
...
if (detailsStart !== -1 && detailsEnd !== -1) {
    lines.splice(detailsStart, detailsEnd - detailsStart + 1, ...detailsLines);
