...
const LOGOUT_MESSAGES = {
    ...
    otp_required: {
        icon: 'alert',
        title: 'ยังไม่ได้ยืนยันรหัส OTP',
        lines: ['อุปกรณ์นี้ยังไม่ได้ยืนยันรหัส OTP ที่ส่งไปทางอีเมล', 'กรุณาเข้าสู่ระบบใหม่แล้วกรอกรหัสให้ครบ'],
        warning: 'หากไม่ได้รับอีเมล กรุณาตรวจกล่องจดหมายขยะ'
    },
    DEFAULT: {
        icon: 'alert',
        title: 'เซสชันหมดอายุ',
