...
function ThemeToggle({ dashboard, showLabel = true, size = 'medium' }) {
  const { toggleTheme, getTheme, THEMES, setActiveDashboard } = useTheme()
  
  const currentTheme = getTheme(dashboard)
