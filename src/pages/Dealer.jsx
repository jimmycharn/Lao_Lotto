...
export default function Dealer() {
    ...
    // Update Line User ID for member
    async function handleUpdateMemberLineUserId(memberId, lineUserId) {
        try {
            const { error } = await supabase
                .from('profiles')
            ...
            setMembers(prev => prev.map(m => m.id === memberId ? { ...m, line_user_id: lineUserId } : m))
        } catch (err) {
            console.error('Error updating member line_user_id:', err)
            toast.error('เกิดข้อผิดพลาดในการอัปเดต Line User ID: ' + err.message)
        }
    }
                                                                                                    ...
                                                                                                    <table className="history-breakdown-table" style={{ width: "max-content", minWidth: "100%", fontSize: "0.85rem", borderCollapse: "collapse" }}>
                                                                                                        <thead>
                                                                                                            <tr style={{ borderBottom: "1px solid var(--color-border)", color: "var(--color-text-muted)", textAlign: "left" }}>
                                                                                                                ...
                                                                                                                <th className="col-entries" style={{ padding: "0.55rem 0.4rem", textAlign: "center", whiteSpace: "nowrap", width: "1%" }}>รายการ</th>
                                                                                                                <th className="col-amount" style={{ padding: "0.55rem 0.65rem", textAlign: "right", whiteSpace: "nowrap", width: "1%" }}>ยอดส่ง</th>
                                                                                                                <th className="col-comm" style={{ padding: "0.55rem 0.65rem", textAlign: "right", whiteSpace: "nowrap", width: "1%" }}>ค่าคอม</th>
                                                                                                                <th className="col-win" style={{ padding: "0.55rem 0.65rem", textAlign: "right", whiteSpace: "nowrap", width: "1%" }}>ถูกรางวัล</th>
                                                                                                                <th className="col-profit" style={{ padding: "0.55rem 0.65rem", textAlign: "right", whiteSpace: "nowrap", width: "1%" }}>กำไร</th>
                                                                                                                <th className="col-settle" style={{ padding: "0.55rem 0.65rem", textAlign: "center", whiteSpace: "nowrap", width: "1%" }}>คงค้าง</th>
                                                                                                            </tr>
                                                                                                        </thead>
                                                                                                        <tbody>
                                                                                                    ...
                                                                                                    <table className="history-breakdown-table" style={{ width: "max-content", minWidth: "100%", fontSize: "0.85rem", borderCollapse: "collapse" }}>
                                                                                                        <thead>
                                                                                                            <tr style={{ borderBottom: "1px solid var(--color-border)", color: "var(--color-text-muted)", textAlign: "left" }}>
                                                                                                                ...
                                                                                                                <th className="col-entries" style={{ padding: "0.55rem 0.4rem", textAlign: "center", whiteSpace: "nowrap", width: "1%" }}>รายการ</th>
                                                                                                                <th className="col-amount" style={{ padding: "0.55rem 0.65rem", textAlign: "right", whiteSpace: "nowrap", width: "1%" }}>ตีออก</th>
                                                                                                                <th className="col-comm" style={{ padding: "0.55rem 0.65rem", textAlign: "right", whiteSpace: "nowrap", width: "1%" }}>ค่าคอม</th>
                                                                                                                <th className="col-win" style={{ padding: "0.55rem 0.65rem", textAlign: "right", whiteSpace: "nowrap", width: "1%" }}>ถูกรางวัล</th>
                                                                                                                <th className="col-profit" style={{ padding: "0.55rem 0.65rem", textAlign: "right", whiteSpace: "nowrap", width: "1%" }}>กำไร</th>
                                                                                                                <th className="col-settle" style={{ padding: "0.55rem 0.65rem", textAlign: "center", whiteSpace: "nowrap", width: "1%" }}>คงค้าง</th>
