...
function parseNumberLine(line, contextMode, isLaoOrHanoi, lotteryType) {
    // Normalize separators: replace - and + between amounts with *
    // e.g., "123=50-6" → "123=50*6", "123 50+6" → "123 50*6"
    // Also handle "ชุด" keyword: "123=50*ชุด" → "123=50*ชุด", "123=50ชุด" → "123=50*ชุด"
    let normalized = line
