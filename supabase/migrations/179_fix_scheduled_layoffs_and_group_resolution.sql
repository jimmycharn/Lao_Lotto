-- Migration: Fix process_due_scheduled_layoffs function
-- Allows scheduled layoffs to trigger up to close_time inclusive
...
BEGIN
    ...
    FOR v_rec IN
        ...
        WHERE r.status = 'open'
          ...
          -- The scheduled time is at or before close_time
