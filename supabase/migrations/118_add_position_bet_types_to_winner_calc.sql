-- Migration: Add position-based single digit bet types to winner calculation
-- =====================================================
-- Missing bet types in calculate_round_winners:
...
--
-- For Thai lottery: 3_top comes from winning_numbers->>'3_top'
-- For Lao/Hanoi: 3_top = last 3 digits of 4_set
-- 2_bottom for Lao = first 2 digits of 4_set
--
-- These are POSITION-SPECIFIC unlike run_top/run_bottom which match ANY position
