-- Migration: Add missing bet types to constraints
-- =====================================================
-- Missing bet types:
-- 2_tang (ถ่างบน/ถ่าง)
-- 2_teng (ลอย/มี)
-- 2_tang_rev (ถ่างกลับ) - if needed separately
...
ALTER TABLE submissions ADD CONSTRAINT submissions_bet_type_check CHECK (bet_type IN (
    ...
    '2_tang', '2_teng',
    -- 2 Digits Reversed
    '2_top_rev', '2_front_rev', '2_spread_rev', '2_bottom_rev', '2_tang_rev', '2_teng_rev',
    -- 3 Digits
