-- Migration: 172_fix_calculate_round_winners_mapping.sql
-- =====================================================
-- Fix: Support correct settings lookup mapping for Lao/Hanoi 3-digit bet types (3_top -> 3_straight, 3_tod -> 3_tod_single) in winner calculation.
-- Also ensure payout rate falls back to default system payout when type_limits has a placeholder 0 payout_rate.
-- =====================================================
